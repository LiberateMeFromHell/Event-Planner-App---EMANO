    ...
    return (
        <div className="event-planner-container">
            ...
            <section className="description">
                <p>
                    Plan and organize your event effortlessly with Event Planner. From birthdays to corporate meetings, we've got you covered.
                </p>
            ...
            <section className="features">
                ...
                <ul>
                    <li><b>Easy</b> event creation and management</li>
                    <li><b>Customizable</b> event templates</li>
                    <li><b>Guest</b> list management</li>
                    <li><b>Real-time</b> collaboration</li>
                    <li><b>Reminders</b> and notifications</li>
                </ul>
            </section>
